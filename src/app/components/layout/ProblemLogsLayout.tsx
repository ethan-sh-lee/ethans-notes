...
export const ProblemLogsLayout = ({ logs, title, link }: { logs: Log[], title: string, link: string }) => {

    return (
        <div className="mx-auto max-w-4xl">
            <h2 className="text-4xl font-extrabold dark:text-white">{title}</h2>
            <Link rel="noopener noreferrer"
                target="_blank" href={link} className="inline-flex items-center justify-center p-5 text-base font-medium text-gray-600 rounded-lg bg-gray-200 hover:text-gray-900 hover:bg-gray-400 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
